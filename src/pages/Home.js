...
const Home = () => {
  ...
  return (
    <>
      ...
      ></iframe>
      <div className={`navbar ${animate ? 'delayed-animate' : 'hidden'}`}>
      ...
      <div className='role'>
        <span className={`text first_text ${animate ? 'delayed-animate' : 'hidden'}`}>I'm </span>
        <span className={`text sec-text ${animate ? 'delayed-animate' : 'hidden'}`} ref={textRef}>
          a Full Stack Developer
        </span>
      </div>
      <div className='options'>
        <button className={`option ${animate ? 'delayed-animate' : 'hidden'}`} onClick={() => openOverlay(<Projects />)}>My Projects</button>
        <button className={`option ${animate ? 'delayed-animate' : 'hidden'}`} onClick={() => openOverlay(<About />)}>About Me</button>
      </div>
      <div className={`resume ${animate ? 'delayed-animate' : 'hidden'}`} onClick={handleResumeClick}>RESUME</div>
	  <div class='cover'></div>
      {menuOpen && (
